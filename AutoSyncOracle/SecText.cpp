...
CString CSecText::secretstr2(CString str)
{
        CString Retstr;
		LPCTSTR Lstr=FILEMODESECUREKY;//,Lstr2;
...
CString CSecText::GetDefaultKey()
{
  return SECRETKEY;
}
...
bool CSecText::IsNumSecType(CString str)
{
     	CString Stempstr,Sinputstr,Simportstr,Schar;
		int newstart,Lstrlen,lp,ks;
		BYTE k;
